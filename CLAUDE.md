...
├── index.md                               # Full user documentation (GitHub Pages)
...
- `index.md` is the landing page at `viveky259259.github.io/ocean-releases`
- Articles are not linked from index.md yet — they can be shared directly via URL
